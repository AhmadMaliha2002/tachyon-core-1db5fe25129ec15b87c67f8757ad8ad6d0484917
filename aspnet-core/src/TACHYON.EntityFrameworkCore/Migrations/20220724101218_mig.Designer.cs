...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Cours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("Course_Hours")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Student", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Student_Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Cours", b =>
                {
                    b.HasOne("TACHYON.MyEntity.Teacher", "teacher")
                        .WithMany("Courses")
                        .HasForeignKey("Teacher_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TACHYON.MyEntity.Department", "department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("TACHYON.MyEntity.Student_Course", b =>
                {
                    b.HasOne("TACHYON.MyEntity.Cours", "cours")
                        .WithMany("Student_Courses")
                        .HasForeignKey("cours_id");

                    b.HasOne("TACHYON.MyEntity.Student", "student")
                        .WithMany("Student_Courses")
